  ...
  pt: {
    translations: {
      header: {
        ...
        privacyCookies: "Políticas de Cookies",
      ...
      expertAdvice: {
        ...
        box1: "Escolha um filtro",
        box2: "Especialidades</br> EHTIQ",
        box21: "Especialidades EHTIQ",
        box3: "Zonas de</br> Corpo",
        box31: "Zonas de Corpo",
        box4: "Preocupações</br> A-Z",
        box41: "Preocupações A-Z",
        box5: "Voltar aos filtros principais",
        box6: "Recomeçar",
      },
      ...
      pages: {
        ...
        home: {
          text1: "Fusão de Beleza e Bem-Estar",
          text2:
          ...
          icon3: "Transporte",
          icon4: "Concierge",
          box71: "Conheça o espaço onde cuidamos de si.",
          admin: {
            sidebar: {
              products: "Produtos",
              backHome: "Home",
      ...
      auth: {
        login: {
          ...
          notClient: "Ainda não é cliente EHTIQ?",
          createAccount: "Criar conta",
        },
        recoverPassword: {
          recoverPassword: "RECUPERAR PASSWORD",
          insertEmail: "Inserir email",
          insertEmailInput: "Insira o e-mail associado à sua conta",
          sentCode: "Enviar código",
          startSession: "Iniciar Sessão",
          validateEmail: "Validar e-mail",
          insertEmailCode: "Insira o código recebido por email",
          proceed: "Avançar",
          newPassword: "Nova password",
          definePassword: "Defina password",
      ...
      visitCardFinal: {
        ...
        startHint: "Comece por categorizar a sua consulta.",
        secondHint:
        ...
        categorizeAppointments: "Vamos categorizar a sua marcação",
        selectProfessional: "Selecione o Profissional de Interesse",
        selectSpeciality: "Selecione a Especialidade de Interesse",
        selectConcern: "Selecione a Preocupação de Interesse:",
        backButton: "Voltar às Opções de Filtragem",
        bestPerson: " A melhor hora para melhor pessoa.",
        chooseDate: "Escolha entre as datas disponíveis:",
